...
-   To follow best practices for statistical reporting. For all statistical tests reported in the plots, the default template abides by the \[APA\](https://my.ilstu.edu/\~jhkahn/apastats.html) gold standard for statistical reporting. For example, here are results from a robust t-test:
    ...
    ![Source: https://r4va.netlify.app/chap10](images/clipboard-2702441495.png)
...
-   ggstatsplot has several dependencies so instead of using pacman, we install it individually as follows. This code is supposed to run once, after that, we only call ggstatsplot via library function.
...
In the code chunk below, [`read_csv()`](https://readr.tidyverse.org/reference/read_delim.html) of [**readr**](https://readr.tidyverse.org/) package is used to import *Exam_data.csv* into R.
...
-   When we are comparing two hypotheses, H1 (the alternate hypothesis) and H0 (the null hypothesis), the Bayes Factor is often written as B10. It can be defined mathematically as
    ...
    ![](images/clipboard-2784087078.png)

<!-- -->

-   The [**Schwarz criterion**](https://www.statisticshowto.com/bayesian-information-criterion/) is one of the easiest ways to calculate rough approximation of the Bayes Factor.**10.3.5**

    ## 6.3.5 How to interpret Bayes Factor

    A **Bayes Factor** can be any positive number. One of the most common interpretations is this one—first proposed by Harold Jeffereys (1961) and slightly modified by [Lee and Wagenmakers](https://www-tandfonline-com.libproxy.smu.edu.sg/doi/pdf/10.1080/00031305.1999.10474443?needAccess=true) in 2013:

    ![Source: https://r4va.netlify.app/chap10](images/clipboard-1307896440.png)
...
ggbetweenstats(
  ...
  pairwise.display = "s", # ns: only non-significant, s: only significant, all: everything
  p.adjust.method = "fdr",
  messages = FALSE
)
```
...
![![Source: https://r4va.netlify.app/chap10](images/clipboard-3020069380.png)](images/clipboard-3825704737.png)
...
ggbarstats(exam1, 
           x = MATHS_bins,
           y = GENDER) +
  scale_fill_manual(values = c("#E91E8C", "#7B5EA7", "#F4811F", "#1B9E77"))
```

...
p <- ggplot(df, aes(x = Positive, y = rate)) +
  ...
  scale_color_gradient(                # adjust color
            low = "green",
            high = "red",
            name = "Fatality Rate") +
...
After using both **FunnelPlotR** and **ggplot2** to draw Funnel Plots, I wonder why **FunnelPlotR** is easy and fast to implement than **ggplot2**, why should we still study **ggplot2** here? I think some of reasons and their different applications are:

-   Use **FunnelPlotR** when I want results fast with correct methodology, but hard to customize beyond package offers.
-   Use **ggplot2** when I need customization or want to understand/show the underlying calculations, despite of manual calculation and steeper learning curve.

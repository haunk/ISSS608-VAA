...
Notice that the background colour of the tooltip is pink (#d8118c), color of hovered point turns to yellow. Notice that the background colour of the tooltip is [pink (#d8118c)]{style="color:#d8118c;"}, color of hovered point turns to [yellow]{style="color:yellow;"}.

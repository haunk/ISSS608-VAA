...
## **11.4 Static Heatmap (**[heatmap](https://www.rdocumentation.org/packages/stats/versions/3.6.0/topics/heatmap))
...
## **11.5 Creating Interactive Heatmap ([heatmaply](http://talgalili.github.io/heatmaply/index.html))**
...
-   Do not worry about the aestheticness now, we will adjust these functions later.
:::
...
### **11.5.5 Statistical approach: Hierarchical Clustering**
...
### [11.5.6 Seriation (Sắp xếp tối ưu) ⭐]{style="font-family: Arial;"}

One of the problems with hierarchical clustering is that it doesn’t actually place the rows in a definite order, it merely constrains the space of possible orderings. Take three items A, B and C. If you ignore reflections, there are three possible orderings: ABC, ACB, BAC. If clustering them gives you ((A+B)+C) as a tree, you know that C can’t end up between A and B, but it doesn’t tell you which way to flip the A+B cluster. It doesn’t tell you if the ABC ordering will lead to a clearer-looking heatmap than the BAC ordering.

**heatmaply** uses the seriation package to find an optimal ordering of rows and columns. Optimal means to optimize the Hamiltonian path length that is restricted by the dendrogram structure. This, in other words, means to rotate the branches so that [the sum of distances between each adjacent leaf (label) will be minimized]{style="font-weight: bold; color: red;"}. This is related to a restricted version of the travelling salesman problem.
...
::: callout-note
Both y-axis and x-axis change their sequences according to each algorithm.
:::
...
::: callout-tips
Colorname has 's': Blues, Reds, Greens...
:::
...
::: callout-tip
Heatmaply is a plotly-based interactive chart, so fig-height chunk options don't control its size. Use the height parameter directly inside heatmaply() instead.
:::

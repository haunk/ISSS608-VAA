...
![](images/clipboard-2092942637.png)
...
![](images/clipboard-4201762626.png)

::: callout-tip
## Name of the color Scale to use for continuous data:

Viridis, Inferno, Magma, Plasma, Warm, Cool, Rainbow, CubehelixDefault, Blues,Greens, Greys, Oranges, Purples, Reds, BuGn, BuPu, GnBu, OrRd, PuBuGn,PuBu, PuRd, RdBu, RdPu, YlGnBu, YlGn, YlOrBr, YlOrRd; default value is Viridis. Here is the [source](https://cran.r-universe.dev/parallelPlot/parallelPlot.pdf).
:::

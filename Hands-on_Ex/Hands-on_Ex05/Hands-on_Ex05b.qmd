...
Follow this article to know how to create such meaningful and beautiful matrices.

```{r}
#| echo: false
#| fig-width: 16 # Adjust width of canvas
...
-   For beautiful display, with ncol = 2 to display 2 charts, it is important to maintain the aspect ratio. Recommended ratio is: 12-6, 14-7 or 16-8.
:::
...
This is very useful and comprehensive source for understanding of **corrplot** package: [An Introduction to corrplot Package](https://cran.r-project.org/web/packages/corrplot/vignettes/corrplot-intro.html).
...
#| fig-height: 8
corrplot(wine.cor, 
         # method = 'square',  # default by circle
         order = 'AOE', 
         addCoef.col = 'black', 
         tl.pos = 'd',
         cl.pos = 'n', 
         col = COL2('PuOr', 10), # color
         p.mat = wine.sig$p, # add significant correlation coefficients
         sig.level = .05, # level of significance
         insig='blank', # hide insignificance
         )
```

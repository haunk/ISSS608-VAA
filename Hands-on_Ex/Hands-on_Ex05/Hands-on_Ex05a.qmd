---
title: "9 Creating Ternary Plot with R"
...
agpop_mutated <- pop_data %>%
  ...
  spread(AG, Population) %>% # Pivots the data from long to wide format
  mutate(YOUNG = rowSums(.[4:8]))%>% # sum column 4-8
...
-   Most points are clustered in the upper-center area
-   High ACTIVE (working-age) population \~60-70%
-   Moderate YOUNG population \~20-30%
-   Lower OLD population \~10-20%
:::
...
::: callout-note
You can use zoom (zoom in/out the plot), pan, lasso and box selection.
:::
